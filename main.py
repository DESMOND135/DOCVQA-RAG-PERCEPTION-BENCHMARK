...
def generate_plots(summary):
    ...
    sns.barplot(data=summary, x="Model", y="Total_Latency", hue="Model", ax=ax2a, palette="flare", legend=True)
    ax2a.set_title("End-to-End Latency")
    ax2a.set_ylabel("Time (Seconds)")
    ax2a.set_xlabel("Perception Model")
    ax2a.legend(title="Perception Model", loc="upper right")
    
    sns.barplot(data=summary, x="Model", y="Throughput", hue="Model", ax=ax2b, palette="crest", legend=True)
    ax2b.set_title("System Throughput")
    ax2b.set_ylabel("Samples per Second")
    ax2b.set_xlabel("Perception Model")
    ax2b.legend(title="Perception Model", loc="upper right")
    ...
    sns.barplot(data=summary, x="Model", y="Memory_Used_MB", hue="Model", palette="magma", legend=True)
    plt.title("Peak Memory Usage During Inference", pad=20)
    plt.ylabel("Memory (Megabytes)")
    plt.xlabel("Perception Model")
    plt.legend(title="Perception Model", loc="upper right")
